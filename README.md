...
├── LICENSE
├── CHANGELOG.md                # List of the latest changes made to the project
...
* Within the **_iac/_** directory, the script **_run.sh_** was created to facilitate the execution of _Terraform_ commands. To create the resources for the production environment, run the commands:
...
* For more information about the process of creating a _cluster Kubernetes_ in _OCI_, consult the official documentation : _[Create a Cluster with Oracle Cloud Infrastructure Container Engine for Kubernetes](https://www.oracle.com/webfolder/technetwork/tutorials/obe/oci/oke-full/index.html)_
...
14. Set the file **_iac/yaml/fotogal-deploy.yaml_** with the path of the _Docker image_ according to the _OCIR_ information created in your _Tenancy_: 
